...
import CommentAreaForm from '../../../components/NewsDetailPage/CommentArea/CommentAreaForm/CommentAreaForm.js';
import { dataToCommentAreaItemList } from '../../../utils/createHtmlElements.js';

const sampleData = [
  {
    avtPath: '../../../public/images/block.jpg',
    name: 'Lân',
    isSubscriber: true,
    date: '1 ngày trước',
  ...
  {
    avtPath: '../../../public/images/salamanca.jpg',
    name: 'Anh em cây khế',
    isSubscriber: false,
    date: '1 ngày trước',
  ...
  {
    avtPath: '../../../public/images/anh_ngoc.jpg',
